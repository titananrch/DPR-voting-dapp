    ...
    <main className="relative flex flex-col min-h-screen ">
      ...
      {connectionState === "connected" && (
        <div className="flex-1 flex mx-auto w-full max-w-7xl">
          ...
          <div className="flex-1 flex min-h-screen">
            <aside className="w-80 border-r border-white/10 pt-4">
              <div className="space-y-4 pt-4 z-40 sticky h-screen" style={{ top: 'var(--header-height, 6rem)' }}>
                {/* TOPICS */}
                <div>
                  <button
                    className={`w-full text-left text-md cursor-pointer transition ${
                      activeView === "topics"
                        ? "text-white"
                  ...
                  {activeView === "parties" && (
                    <ul className="mt-2 ml-3 space-y-1 text-sm">
                      {parties.map((p) => (
                        <li key={p.id}>
                          <button
                            className={`w-full text-left px-2 py-1 cursor-pointer rounded transition ${
            ...
            <section className="flex-1 flex flex-col pt-4 ">
              {/* HEADER - Sticky header below wallet */}
              {activeView === "topics" && (
                <div className="sticky flex items-center bg-[#0E0E0E] justify-between px-6 py-4 shrink-0 z-30" style={{ top: 'var(--header-height, 6rem)' }}>
      ...
      {connectionState === "connected" && (
        <footer className="border-t border-white/10 bg-black/10 p-6 text-center text-sm text-white/50 flex mx-auto w-full justify-center gap-1">
          ...
          <a
            href="https://github.com/titananrch"
